...
public class BankServiceTest {
    ...
    @Test
    public void whenNotAddUser() {
        User first = new User("3434", "Petr Arsentev");
        User second = new User("3434", "P Sbk");
        BankService bank = new BankService();
        bank.addUser(first);
        bank.addUser(second);
        assertThat(bank.findByPassport("3434").getUsername()).isNotEqualTo("P Sbk");
    }

    @Test
    public void deleteUserIsTrue() {
        User first = new User("3434", "Petr Arsentev");
        User second = new User("3433", "Petr Arsentev");
        BankService bank = new BankService();
        bank.addUser(first);
        bank.addUser(second);
